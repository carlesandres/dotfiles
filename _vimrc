...
if executable('ag')
  let g:unite_source_rec_async_command = ['ag', '--skip-vcs-ignores', '--vimgrep', '--hidden', '-g', '']
  let g:unite_source_grep_command = 'ag'
  " let g:unite_source_grep_default_opts = '--skip-vcs-ignores'
  " let g:unite_source_grep_default_opts = '--column --nogroup --nocolor --follow --skip-vcs-ignores'
  " let g:unite_source_grep_default_opts = '--skip-vcs-ignores --vimgrep --hidden --ignore ''.hg'' --ignore ''.svn'' --ignore ''.git'' --ignore ''.bzr'''
  let g:unite_source_grep_default_opts = '--skip-vcs-ignores --vimgrep --hidden'
